...
export default function Onboarding() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            // We use the environment variable as the primary source.
            if (!baseUrl) {
                console.warn("NEXT_PUBLIC_BACKEND_URL is not set. Using fallback for dev potentially, or this will fail.");
            }

            // Construct the full URL. If baseUrl is missing, this might form an invalid URL or a relative one depending on browser,
            // but for production correctness with a separate backend, strict env var is better. 
            // However, to prevent crash if undefined, we can default to empty string which results in "/api/lead" (relative).
            // But per requirements, we must use the env var.
            ...
            try {
                ...
                // If response is not JSON (e.g. 404 HTML, 500 text), handle gracefully
